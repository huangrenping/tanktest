		...
		<%	
			...
			if(datetimepicker1!=null && !datetimepicker1.equals("") &&
			   ...
			   for(int i=0; i<huodongstr3.length; i++){
			   		...
			   		if(Integer.valueOf(huodongstr4[0])==9){
			   			huodongstr3[i]="9@"+radio1+"@"+time1+"@"+time2+"@"+0;
			   			WgMain wgMain=activityManager.getWgMain();
			   			wgMain.setSevendayprice(Integer.valueOf(price));
			...
			for(int i=0; i<huodong2.length; i++){
				...
				if(Integer.valueOf(huodong3[0])==9){
					...
					request.setAttribute("price", activityManager.getWgMain().getSevendayprice());
...
<body class="theme-black">
	...
	<!-- 内容区域 -->
	<form id="send" action="upsevendays.jsp" method="post" id="hp_form" name="hp_form" data-am-validator
				...
				<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
					<div class="widget am-cf">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input value="限时充值活动" id="name" name="name" type="text"
										class="tpl-form-input" readonly="readonly">
								</div>
							</div>
							
							<div class="am-form-group">
								<label for="user-name" class="am-u-sm-3 am-form-label">充值金额(元):
									<span class="tpl-form-line-small-"></span>
								</label>
								<div class="am-u-sm-9">
