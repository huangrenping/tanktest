...
<% 
		...
		for (WgPlayerserver wgPlayerserver : players) {
		    if(mapserver.get(wgPlayerserver.getUsername())!=null){
		        wgPlayerserver.getWgPlayerserver2().setZhanlingbuygiftbag(1);
		        wgPlayerserver.getWgPlayerserver2().setDirty(true);
		        out.println("-----add-----"+wgPlayerserver.getPlayername()+"---"+wgPlayerserver.getServeruid()+"<br>");
		    }
