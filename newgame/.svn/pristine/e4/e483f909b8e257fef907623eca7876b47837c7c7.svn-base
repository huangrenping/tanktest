  ...
  var dateTimePicker = function(element, options) {
    var picker = {},
      ...
      place = function() {
        ...
        var kd_left="";
       // horizontal === 'left' ? offset.left-widgetWidth : offset.left + referWidth - widgetWidth
        if(horizontal === 'left'){
        	if(offset.left-widgetWidth<0){
        		kd_left=offset.left;
        		style.top=offset.top- element.outerHeight()*2
        	}else{
        		kd_left=offset.left-widgetWidth
        	}
        	
        }else{
        	kd_left=offset.left + referWidth - widgetWidth;
        }
