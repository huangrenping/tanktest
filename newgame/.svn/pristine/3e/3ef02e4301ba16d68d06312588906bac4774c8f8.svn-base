		...
		<%	
			...
			if(parameter!=null && !parameter.equals("")){
				if(parameter.equals("1")){
					...
					wgMain2.setCatmasege("");
					activityManager.updatewgmain2(wgMain2);
					response.getWriter().write("<script>window.location.href='../activity/cat.jsp'</script>");
					return;
				}
			...
			if(datetimepicker1!=null && !datetimepicker1.equals("") &&
			   ...
			   for(int i=0; i<huodongstr3.length; i++){
			   		...
			   		if(Integer.valueOf(huodongstr4[0])==14){
			   			huodongstr3[i]="14@"+radio1+"@"+time1+"@"+time2+"@"+0;
			...
			for(int i=0; i<huodong2.length; i++){
				...
				if(Integer.valueOf(huodong3[0])==14){
...
<body class="theme-black">
	...
	<!-- 内容区域 -->
	<form id="send" action="upcat.jsp" method="post" id="hp_form" name="hp_form" data-am-validator
				...
				<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
					<div class="widget am-cf">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input value="招财猫" id="name" name="name" type="text"
