...
<%
			...
			if(huodong==null || huodong.equals("")){
				...
				//副本活动不确定，id待定
				//activityManager.upWgmainhuodong("11@0@0@0@0");
			}else{
				int num=0;
				...
				if(num==0){
					//副本活动不确定，id待定
					//activityManager.upWgmainhuodong(huodong+",11@0@0@0@0");
				}
			}
			...
			for(int i=0; i<huodong5.length; i++){
				...
				//副本活动不确定，id待定
				 if(Integer.valueOf(huodong6[0])==11){
			...
			String info="";
			if(timelimitChapter!=null){
				info=timelimitChapter.getChaptername()+"("+timelimitChapter.getDescription()+")";
			}
	 ...
	 function getoperation(){
	 	$(document).on('click','#operation',function(){
	 		...
	 		layer.open({
	 			...
	 			shadeClose:true,
	 			anim:0,
	 			content:[webPath+'/adm/activity/uptimelimitplot.jsp'],
	 	    	end:function(){
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">剧情副本配置信息</div>
