...
<jsp:include page="${webRoot}/WEB-INF/jsp/common/cssJsPage.jsp"></jsp:include>
    <script type="text/javascript">
		...
		function selectwg(){
			...
			$("#addressbody").empty();
	 		var content="";
	 		location.href = webPath+'/admin/allwglist?username='+userName+'&playername='+playName+'&rolename='+roleName;
	 	});
		};
	 ...
	 function previouspage(){
	 	$(document).on('click','#previouspage',function(){
			...
			document.getElementById("pageNo").value=page;  
			location.href = webPath+'/admin/allwglist?pageNo='+page;
	 	});
	 };
	 ...
	 function lastpage(){
	 	$(document).on('click','#lastpage',function(){
	 		...
	 		location.href = webPath+'/admin/allwglist?pageNo='+lastpage;
	 	});
	 };
	 ...
	 function homepage(){
	 	$(document).on('click','#homepage',function(){
	 		...
	 		location.href = webPath+'/admin/allwglist?pageNo=1';
	 	});
	 };
		 //跳转
	 function jump(){
	 	$(document).on('click','#jumpbut',function(){
	 		...
	 		$("#addressbody").empty();
	 		var content="";
	 		location.href = webPath+'/admin/allwglist?pageNo='+jump;
	 		}
	 	});
	 };	
                                ...
                                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    	<table>
	                                    	<tr>
	                                    		<td>
													<input type="text" class="am-form-field" placeholder="请输入编号" align="right"
