    ...
    <script src="<%=path %>/assets/js/amazeui-pagination.js"></script>
		<%	
			...
			if(radio1!=null && !radio1.equals("")){
			   ...
			   if(wgMain.getRechargeopen()==Integer.valueOf(radio1)){
			   }else{
				   wgMain.setRechargeopen(Integer.valueOf(radio1));
				   activityManager.upWgmain(wgMain,0);
			   }
			}
			int rechargeopen=activityManager.getRechargeopen();
...
<body class="theme-black">
	...
	<!-- 内容区域 -->
	<form action="uprecharge.jsp" method="post" id="hp_form" name="hp_form" data-am-validator
