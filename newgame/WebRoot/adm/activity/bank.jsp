...
<%
			...
			if(huodong==null || huodong.equals("")){
				...
				activityManager.upWgmainhuodong("8@0@0@0@0");
			}else{
				int num=0;
				...
				if(num==0){
					activityManager.upWgmainhuodong(huodong+",8@0@0@0@0");
				}
			}
			...
			for(int i=0; i<huodong5.length; i++){
				...
				if(Integer.valueOf(huodong6[0])==8){
			...
			if(bank!=null && !bank.equals("")){
				...
				for(int i=0; i<bankarray.length; i++){
					...
					lvandnum+=bankarray2[0]+":"+bankarray2[1]+",";
				}
				if(lvandnum!=null && !lvandnum.equals("")){
					if(lvandnum.substring(lvandnum.length()-1, lvandnum.length()).equals(",")){
						lvandnum=lvandnum.substring(0, lvandnum.length()-1);
					}
				}
			}
			request.setAttribute("lvandnum", lvandnum);
%>
	 ...
	 function getoperation(){
	 	$(document).on('click','#operation',function(){
	 		...
	 		layer.open({
	 			...
	 			shadeClose:true,
	 			anim:0,
	 			content:[webPath+'/adm/activity/upbank.jsp'],
	 	    	end:function(){
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">聚宝钱庄配置信息</div>
                            </div>
