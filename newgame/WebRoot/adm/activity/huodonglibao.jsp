...
<%
			...
			if(activityinfo!=null && !activityinfo.equals("")){
				...
				request.setAttribute("starttime", Util.getDate(startime, 1));
				...
				if(article!=null){
					request.setAttribute("articlename", article.getName());
				}
			}
%>
	 ...
	 function getoperation(){
	 	$(document).on('click','#operation',function(){
	 		...
	 		layer.open({
	 			...
	 			shadeClose:true,
	 			anim:0,
	 			content:[webPath+'/adm/activity/uphuodonglibao.jsp'],
	 	    	end:function(){
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">活动礼包配置信息</div>
