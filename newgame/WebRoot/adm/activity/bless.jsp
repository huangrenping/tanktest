...
<%
			...
			if(huodong==null || huodong.equals("")){
				...
				activityManager.upWgmainhuodong("17@0@0@0@0");
			}else{
				int num=0;
				...
				if(num==0){
					activityManager.upWgmainhuodong(huodong+",17@0@0@0@0");
				}
			}
			...
			for(int i=0; i<huodong5.length; i++){
				...
				if(Integer.valueOf(huodong6[0])==17){
...
<%-- 	layui.config({
	 ...
	 function getoperation(){
	 	$(document).on('click','#operation',function(){
	 		...
	 		layer.open({
	 			...
	 			shadeClose:true,
	 			anim:0,
	 			content:[webPath+'/adm/activity/upbless.jsp'],
	 	    	end:function(){
	 ...
	 function actreset(){
		 	$(document).on('click','#actreset',function(actreset){
			 	 layer.closeAll();
	 			 layer.confirm('注意:确定重置吗?', {icon: 0, title:'一键重置'}, function(index){
				  	location.href =webPath+'/adm/activity/upbless.jsp?parameter=1';
				}) 
			})
		};
</script>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">限时祈福概率活动</div>
