		...
		<%	
			...
			if(parameter!=null && !parameter.equals("")){
				if(parameter.equals("1")){
				    PlayerManager.getInstance().chongzhi1();
					wgMain2.setCadidprobability("0,0,0");
			 		activityManager.updatewgmain2(wgMain2);
					response.getWriter().write("<script>window.location.href='../activity/bless.jsp'</script>");
					//out.println("重置成功");
					return;
				}
			...
			if(datetimepicker1!=null && !datetimepicker1.equals("") &&
			   ...
			   newcardid!=null && !newcardid.equals("") &&
			   newcardnum!=null && !newcardnum.equals("") &&
			   newcardnum2!=null && !newcardnum2.equals("")){
			   ...
			   for(int i=0; i<huodongstr3.length; i++){
			   		...
			   		if(Integer.valueOf(huodongstr4[0])==17){
			   			huodongstr3[i]="17@"+radio1+"@"+time1+"@"+time2+"@"+0;
			...
			for(int i=0; i<huodong2.length; i++){
				...
				if(Integer.valueOf(huodong3[0])==17){
			...
			if(cadidprobability2.length<3){
				wgMain2.setCadidprobability("0,0,0");
				cadidprobability2=wgMain2.getCadidprobability().split(",");
			}
...
<body class="theme-black">
	...
	<!-- 内容区域 -->
	<form id="send" action="upbless.jsp" method="post" id="hp_form" name="hp_form" data-am-validator
				...
				<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
					<div class="widget am-cf">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input value="限时祈福概率活动" id="name" name="name" type="text"
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input value="${cardnum}" id="cardnum" name="cardnum" type="text"
										class="tpl-form-input"placeholder=""> <small>友情提示：假如填入60,几率为100分之60</small>
								</div>
							</div>
