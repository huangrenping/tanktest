...
<%
			...
			if(huodong==null || huodong.equals("")){
				...
				activityManager.upWgmainhuodong("14@0@0@0@0");
			}else{
				int num=0;
				...
				if(num==0){
					activityManager.upWgmainhuodong(huodong+",14@0@0@0@0");
				}
			}
			...
			for(int i=0; i<huodong5.length; i++){
				...
				if(Integer.valueOf(huodong6[0])==14){
	 ...
	 function getoperation(){
	 	$(document).on('click','#operation',function(){
	 		...
	 		layer.open({
	 			...
	 			shadeClose:true,
	 			anim:0,
	 			content:[webPath+'/adm/activity/upcat.jsp'],
	 	    	end:function(){
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">招财猫配置信息</div>
