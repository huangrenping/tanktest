...
<script type="text/javascript">
	layui.config({
		  base: '${webPath}/admin/specification/specificationsdetail/' //你存放新模块的目录，注意，不是layui的模块目录
		}).use('specificationsdetaillist'); //加载入口
</script>
				...
				<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
					<div class="widget am-cf">
						<div class="widget-head am-cf">
							<div class="widget-title  am-cf">规格明细列表</div>
						</div>
						<div class="widget-body  am-fr">
								...
								<div class="am-form-group">
									<div class="am-btn-toolbar">
										<div class="am-btn-group am-btn-group-xs">
											<button type="button"
												class="am-btn am-btn-default am-btn-success" id="savebut">
							...
							<div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                                    <div class="am-form-group tpl-table-list-select">
                                        <select data-am-selected="{btnSize: 'sm'}" name="specificationsId" id="goodsTypeId">
