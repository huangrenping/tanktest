...
<%
	...
	if(username!=null && !username.equals("") && roleid!=null && !roleid.equals("")){
		...
		int error=LoginManager.getInstance().insert(wgAdmin);
		if(error==1){
...
<body class="theme-black">
	<form id="hp_form" action="saveuser.jsp" method="post" data-am-validator
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input value="${user.username}" id="username" name="username" type="text"
										class="tpl-form-input"><small>注意：密码默认6个8</small>
								</div>
							</div>
								...
								<div class="am-u-sm-9">
									<select id="roleid" name="roleid"
										data-am-selected="{searchBox: 1}" style="display: none;">
											<s:forEach var="list" items="${wgrolelist}">
