...
<%
			...
			if(huodong==null || huodong.equals("")){
				...
				activityManager.upWgmainhuodong("7@0@0@0@0");
			}else{
				int num=0;
				...
				if(num==0){
					activityManager.upWgmainhuodong(huodong+",7@0@0@0@0");
				}
			}
			...
			for(int i=0; i<huodong5.length; i++){
				...
				if(Integer.valueOf(huodong6[0])==7){
			...
			if(summercard!=null){
				...
				if(summercardarray[0]!=null){
					Article article=articleManager.getarticle(Integer.valueOf(summercardarray[0]));
					if(article!=null){
				...
				if(summercardarray[2]!=null){
					...
					for(int i=0; i<summercardarray2.length; i++){
						Article article=articleManager.getarticle(Integer.valueOf(summercardarray2[i]));
						if(article!=null){
							articlename2=articlename2+article.getName()+",";
						}
					}
					if(articlename2!=null && !articlename2.equals("")){
						if(articlename2.substring(articlename2.length()-1, articlename2.length()).equals(",")){
						articlename2=articlename2.substring(0, articlename2.length()-1);
						}
					}
				}
			}
			...
			request.setAttribute("articlename2", articlename2);
%>
	 ...
	 function getoperation(){
	 	$(document).on('click','#operation',function(){
	 		...
	 		layer.open({
	 			...
	 			shadeClose:true,
	 			anim:0,
	 			content:[webPath+'/adm/activity/upsummer.jsp'],
	 	    	end:function(){
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">${huodongname}配置信息</div>
                            </div>
