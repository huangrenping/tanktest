		...
		<%	
			...
			if(datetimepicker1!=null && !datetimepicker1.equals("") &&
			   ...
			   for(int i=0; i<huodongstr3.length; i++){
			   		...
			   		if(Integer.valueOf(huodongstr4[0])==23){
			   			huodongstr3[i]="23@"+radio1+"@"+time1+"@"+time2+"@"+0;
...
<body class="theme-black">
	...
	<!-- 内容区域 -->
	<form id="send" action="upquestionnaire.jsp" method="post" id="hp_form" name="hp_form" data-am-validator
				...
				<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
					<div class="widget am-cf">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input value="问卷配置信息" id="name" name="name" type="text"
