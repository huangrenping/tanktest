		...
		<%	
			...
			if(datetimepicker1!=null && !datetimepicker1.equals("") &&
			   ...
			   for(int i=0; i<huodongstr3.length; i++){
			   		...
			   		if(Integer.valueOf(huodongstr4[0])==19){
			   			huodongstr3[i]="19@"+radio1+"@"+time1+"@"+time2+"@"+radio2;
			...
			for(int i=0; i<huodong2.length; i++){
				...
				if(Integer.valueOf(huodong3[0])==19){
					...
					request.setAttribute("issend", huodong3[4]);
					break;
				}
			}
...
<body class="theme-black">
	...
	<!-- 内容区域 -->
	<form id="send" action="upclothingcollect.jsp" method="post" id="hp_form" name="hp_form" data-am-validator
				...
				<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
					<div class="widget am-cf">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input value="服装收集活动" id="name" name="name" type="text"
