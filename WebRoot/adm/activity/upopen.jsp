    ...
    <script src="<%=path %>/assets/js/amazeui-pagination.js"></script>
		<%	
			...
			if(radio1!=null && !radio1.equals("")){
			   if(wgMain.getOpen()==Integer.valueOf(radio1)){
			   }else{
				   wgMain.setOpen(Integer.valueOf(radio1));
				   activityManager.upWgmain(wgMain,1);
				   wgMain.openserver();
			   }
			}
			int rechargeopen=wgMain.getOpen();
...
<body class="theme-black">
	...
	<!-- 内容区域 -->
	<form action="upopen.jsp" method="post" id="hp_form" name="hp_form" data-am-validator
