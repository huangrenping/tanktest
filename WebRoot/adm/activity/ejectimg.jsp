...
<%
			...
			request.setAttribute("imgname", "");
			WgMain2 wgMain2=activityManager.getWgMain2();
			String ejectimg=wgMain2.getEjectimg();
			if(ejectimg!=null && !ejectimg.equals("")){
				request.setAttribute("imgname", ejectimg);
			}
%>
	 ...
	 function getoperation(){
	 	$(document).on('click','#operation',function(){
	 		...
	 		layer.open({
	 			...
	 			shadeClose:true,
	 			anim:0,
	 			content:[webPath+'/adm/activity/upejectimg.jsp'],
	 	    	end:function(){
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">弹出图片配置信息</div>
