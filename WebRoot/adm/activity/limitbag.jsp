...
<%
			...
			if(huodong==null || huodong.equals("")){
				...
				activityManager.upWgmainhuodong("12@0@0@0@0");
			}else{
				int num=0;
				String[] huodong2=huodong.split(",");
				for(int i=0; i<huodong2.length; i++){
					String[] huodong3=huodong2[i].split("@");
					if(Integer.valueOf(huodong3[0])==12){
						num++;
						break;
					}
				}
				if(num==0){
					activityManager.upWgmainhuodong(huodong+",12@0@0@0@0");
				}
			}
			...
			for(int i=0; i<huodong5.length; i++){
				...
				if(Integer.valueOf(huodong6[0])==12){
	 ...
	 function getoperation(){
	 	$(document).on('click','#operation',function(){
	 		...
	 		layer.open({
	 			...
	 			shadeClose:true,
	 			anim:0,
	 			content:[webPath+'/adm/activity/uplimitbag.jsp'],
	 	    	end:function(){
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">限购礼包配置信息</div>
