   ...
   //注意，这里是模块输出的核心，模块名必须和list时的模块名一致
	//一进入,页面进行全查询
	 ...
	 function getaddall(pageNum,url){
		 queryAll(pageNum,"/shopping/selectallshoppingpage");
	 }
	 				...
	 				$.each(pageList,function(index,item){
	 					...
	 					if(show==1){
	 						...
	 						$("#addressbody").append('<tr class="gradeX">'+
	                                 ...
	                                 '<td class="am-text-middle">'+item.articleid+'</td>' +
	                                 '<td class="am-text-middle">'+isremairesult+'</td>' +
	                                 '<td class="am-text-middle">'+montyperesult+'</td>' +
	                                 '<td class="am-text-middle">'+item.price+'</td>' +
	                                 '<td class="am-text-middle">'+item.starttime+'</td>' +
	                                 '<td class="am-text-middle">'+item.endtime+'</td>' +
	                                 '<td class="am-text-middle">'+item.count+'</td>' +
	                                 '<td class="am-text-middle">'+showresult+'</td>' +
	 ...
	 function getreceedit(){
	 	...
	 	$(document).on('click','#selectoneuser',function(){
	 		...
	 		layer.open({
	 			...
	 			closeBtn:1,
	 			anim:0,
	 			content:[webPath+'/shopping/selectoneshopping?id='+id],
	 	    	end:function(){
	 	    		getaddall(1);
	 	    	}
	 		});
